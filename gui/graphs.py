...
def plot_poly_data(wl_grid: list, all_ch_data: list, laser_wl: float):
    ...
    sc.axes.vlines(
        laser_wl,
        ymin=min(all_ch_data[0]),
        ymax=max(all_ch_data[0]),
        color="r",
        linestyle="--",
    )
    return sc
...
def plot_section(
    wl_grid: list, section_Evans: list, section_Selden: list, laser_wl: float
):
    ...
    sc.axes.vlines(
        laser_wl,
        ymin=min(section_Evans),
        ymax=max(section_Evans),
        color="r",
        label="laser wl",
        linestyle="--",
    )
